...
$(document).ready(function() 
 {
		var commentNew = 0;
 		$("#btn_more").click(function()
 		{
				...
				$("#box").load("php/load-comments.php",{
...
$(document).ready(function() 
 {
 	...
 	$("#form-set").submit(function(event)
 	{
 		...
 		$("#form-message").load("php/setComment.php", {
 			message: message,
 			submit: submit,
 			uid: uid,
 			date: date
 ...
 $(document).ready(function() 
 {
        ...
        var body_message = document.getElementById('contact_message').value;
		var subject = document.getElementById('contact_subject').value;
		var name = document.getElementById('contact_name').value;

		var mailto = "khmonolitbud@gmail.com";
		var all = "Тема: " + subject + " ; Имя заказчика: " +name;

		    var mailto_link = 'mailto:' + mailto + '?subject=' + all + '&body=' + body_message;
